    ...
    <>
      ...
      <div className='projects'>
        <section>
          ...
          <img src={discoball} alt="screenshot of discoball.fm homepage" width="650"></img>
          <p>
        ...
        <section>
          ...
          <img src={snake} alt="screenshot of snake game" width="650"></img>
          <p>
          ...
          <p>
            One notable challenge of programming a snake game in Jack was positioning the new food target in a random location every time it was eaten. In Jack, there is no standard library method to output a random number. Within a computer program, there is no such thing as a truly random number. Usually what is output from a built-in function is a "pseudo-random" number generated from a starting "seed", and math is used to make the result look random, with possibly an added environmental element to increase unpredictability. The environmental element is sometimes the current time or some user actions which always change. In Jack, the os.time method did not return a value, so that method was not available.
          </p>
          <p>
